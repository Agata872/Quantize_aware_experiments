...
class Full_server_process(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Full_server_process", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Full_server_process")
        ...
        self.samp_rate = samp_rate = 199200
...
def main(top_block_cls=Full_server_process, options=None):
