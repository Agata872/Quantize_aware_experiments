...
class server_process(gr.top_block):
    ...
    def __init__(self):
        ...
        self.connect((self.analog_random_source_x_0, 0), (self.pdu_tagged_stream_to_pdu_0, 0))
        ...
        self.connect((self.digital_diff_decoder_bb_0_0, 0), (self.pdu_tagged_stream_to_pdu_0_0, 0))
