...
def main():
    ...
    TX1_SCRIPT_PATH = "~/Gnn_based_downlink_precoder_Deployment/Downlink/Tx.py"
    RX_SCRIPT_PATH = "~/Gnn_based_downlink_precoder_Deployment/Downlink/beamform.py"
    ...
    def run_and_store(target, path):
        ...
        remote_cmd = (
            'cd ~/Gnn_based_downlink_precoder_Deployment/Downlink && '
